...
public class Object3d {
    ...
    private final Number3d _position = new Number3d(0, 0, 0);
    private final Number3d _rotation = new Number3d(0, 0, 0);
    private final Number3d _scale = new Number3d(1, 1, 1);
    private float initialScale;// TODO added
    ...
    // TODO added
    public void setModelViewMatrix(double[] matrix) {
        for (int i = 0; i < 16; i++) {
            Double n = Double.valueOf(matrix[i]);
            modelViewMatrix[i] = n.floatValue();
        }
    }
    ...
    public void initialScale(float f) {
        initialScale = f;
    }
