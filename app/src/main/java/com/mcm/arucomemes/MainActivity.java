...
//                runOnUiThread(() -> text.append(d));
    ...
    private final String ACTION_USB_PERMISSION = "com.mcm.arucomemes.USB_PERMISSION";
...
//        this.serverThread.start();
    ...
    public void checkUSB(View view) {
        try {
            System.loadLibrary("arucomemes");
            Log.d("DevMain", String.valueOf(DevMain.main()));
        } catch (Exception e) {
            e.printStackTrace();
        }
